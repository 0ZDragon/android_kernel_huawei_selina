...
static int spk_hs_hpa_off_control_en = 0;
		      ...
		      bool impedance_det_en)
{
    ...
    spk_hs_hpa_off_control_en = (of_property_read_bool(card->dev->of_node, spk_hs_hph_off_bypass)?1:0);
    pr_debug("%s: spk_hs_hpa_off_control_en = %d\n", __func__, spk_hs_hpa_off_control_en);
	mbhc->in_swch_irq_handler = false;
	mbhc->current_plug = MBHC_PLUG_TYPE_NONE;
